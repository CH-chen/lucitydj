# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-10-22 12:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.UserInfo', verbose_name='拥有者')),
            ],
            options={
